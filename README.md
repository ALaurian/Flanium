...
2  |  [GetWindowByProcessId](https://github.com/ALaurian/Flanium/blob/main/Documentation/GetWindowByProcessId)  |  WaitForAlert  |  InitializeChrome  |  FolderContainsFiles
