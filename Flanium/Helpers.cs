...
namespace Flanium
{
    internal class Helpers
    {
        ...
        RetrySAPConnection:
            ...
            session.ActiveWindow.SendVKey(0);
            AutomationElement window = automation.GetDesktop().FindAllChildren().Single(x => x.Name == "SAP Easy Access");
        ...
        public static DataTable ExcelToDataTable(string path, int rowToDelete = 1)
        {
            Console.WriteLine(" ");
            Console.WriteLine("----------------------------");
            ...
            Range allDataRange = xlWorkSheet.UsedRange;
            allDataRange.Sort(allDataRange.Columns[66], XlSortOrder.xlAscending, Header: XlYesNoGuess.xlYes);
