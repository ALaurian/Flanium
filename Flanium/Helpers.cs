    ...
    public class Helpers
    {
            ...
            string sapClientId, string sapshcutPath = @"C:\Program Files (x86)\SAP\FrontEnd\SapGui\sapshcut.exe")
        {
            ...
            try
            {
                ...
                object engine = sapGuilRot.GetType().InvokeMember("GetScriptingEngine", BindingFlags.InvokeMethod, null,
                    sapGuilRot, null);
        ...
        public static DataTable ExcelToDataTable(string path, int sheet = 1, int rowToDelete = -1,
